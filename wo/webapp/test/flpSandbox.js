		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WorkOrder",
									"targetURL": "#comchappotawowo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchappotawowo-display": {
								"semanticObject": "comchappotawowo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chappota.wo.wo",
									"url": sap.ui.require.toUrl("com/chappota/wo/wo")
								}
							}
						}
					}
